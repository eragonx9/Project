...
const VenueBooking = () => {
  ...
  const handleRejectBooking = async (id) => {
    try {
      // Make a PUT request to update the booking status to "rejected"
      const response = await fetch(`http://localhost:5000/reject-venue-booking/${id}`, {
        method: 'PUT',
        headers: {
          'Content-Type': 'application/json',
        },
      ...
      console.error('Error rejecting venue booking:', error.message);
    }
  };
